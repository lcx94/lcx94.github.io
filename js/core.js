...
!function(a)
  {var
    ...
    g={scriptReady:
      function(a,b){
        ...
        c.readyState?c.onreadystatechange=function(){
          (c.attachEvent?"complete"===c.readyState:"loading"!==c.readyState)
          &&(c.onreadystatechange=null,b&&b())
        }:c.onload=function(){b&&b()}
      },
      ...
      getComboUrl:function(){
        var a="";
        for(var b in k)a+=(0==b?"":",")+m[k[b]]+".js";return l+"??"+a+"?v="+d
      },
    ...
    m={sea:"sea-modules/seajs/seajs/2.2.1/sea",
    ...
    global:"plus/global"},
    n={isReady:!1,init:!1,ready:function(a)
        {if(!n.init)
          if(n.init=!0,e.addEventListener)e.addEventListener("DOMContentLoaded",function()
          {e.removeEventListener("DOMContentLoaded",arguments.callee,!1),a()},!1);
    ...
    g.scriptReady("JS_core"),n.ready(function(){/233.com/gi.test(f)&&g.getScript(l+m.tongji+".js?v="+b)}),
    a.core={version:b,update:c,timestamp:d,utils:g,ready:n.ready}
  }
  (window);
